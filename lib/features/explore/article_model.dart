...
const kArticles = <Article>[
  ...
  Article(
    ...
    imageUrl: '$_u-1491555103944-7c647fd857e6?auto=format&fit=crop&w=1200&q=80',
    body: [
  ...
  Article(
    ...
    imageUrl: '$_u-1536256263959-49fc93bb0d7e?auto=format&fit=crop&w=900&q=75',
    body: [
  ...
  Article(
    ...
    imageUrl: '$_u-1499750310107-5fef28a66643?auto=format&fit=crop&w=900&q=75',
    body: [
  ...
  Article(
    ...
    imageUrl: '$_u-1546069901-ba9599a7e63c?auto=format&fit=crop&w=900&q=75',
    body: [
  ...
  Article(
    ...
    imageUrl: '$_u-1506126613408-eca07ce68773?auto=format&fit=crop&w=900&q=70',
    body: [
  ...
  Article(
    ...
    imageUrl: '$_u-1631049307264-da0d7539e0b7?auto=format&fit=crop&w=900&q=75',
    body: [
  ...
  Article(
    ...
    imageUrl: '$_u-1482049016688-2d3e1b311543?auto=format&fit=crop&w=900&q=75',
    body: [
  ...
  Article(
    ...
    imageUrl: '$_u-1515886657613-9f3515b0c78f?auto=format&fit=crop&w=900&q=75',
    body: [
  ...
  Article(
    ...
    imageUrl: '$_u-1571019613454-1cb2f99b2d8b?auto=format&fit=crop&w=900&q=75',
    body: [
  ...
  Article(
    ...
    imageUrl: '$_u-1544367571-8b0a8c9eb5a9?auto=format&fit=crop&w=900&q=75',
    body: [
